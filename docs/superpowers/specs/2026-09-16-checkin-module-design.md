...
- 出参后做**存在性校验**：若生成内容中不含求助渠道，则追加下面这段固定文案。
- 所有等级 2 的生成结果**落库并进入运营复核队列**，供心理专业同事抽查，据此迭代 prompt。

### 固定求助渠道文案（暂定版）

在产品与心理专业同事给出最终版本之前，**存在性校验失败时追加这段**：
...
号码来源（2026-09 核对，均为官方口径）：

| 号码 | 依据 |
| --- | --- |
| 12356 | 国家卫生健康委《关于应用"12356"全国统一心理援助热线电话号码的通知》（国卫医政函〔2024〕259号），要求 2025-05-01 前全国统一启用 |
| 12355 | 共青团中央青少年服务台 |
| 110 / 120 | 国卫医政函〔2024〕259号 明确要求心理援助与 110、119、120 建立联动机制 |

**实施时两条不能违反：**

1. **不要对外宣称 12356 是「24 小时」。** 国家文件的要求是「每日提供不少于 18 小时心理援助服务」，各地实际时长不一。文案里**不写服务时间**，避免用户按错误预期拨打。
2. **12355 的人工接听时段各地不同**（有的地区 8:00—23:00 人工、夜间语音留言，也有地区 7×24）。同样不写时间。**危机场景下让用户拨一个可能没人接的号码是有害的**——所以这段把 12356 排在第一，并以 110 / 120 保底。

**这是暂定文案，不是终稿。** 最终措辞与号码仍需产品与心理专业同事确认（尤其是否需要补充地区性热线），但**它不再阻塞上线**。
...
| 等级 2 用户侧求助渠道的具体号码与措辞 | 产品 + 心理专业同事 | 影响等级 2 文案措辞 | **暂定：已用固定模板兜底**（见 5.4），**不再阻塞上线**；最终版仍待确认 |
